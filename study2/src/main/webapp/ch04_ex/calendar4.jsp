...
<%
		...
		for(int i=1; i<week; i++) {
			out.print("<td class='gray' onclick='selectDate("+preYear+","+preMonth+","+preDate+");'>"+(preDate++)+"</td>");
		}
		...
		for(int i=1; i<=lastDay; i++) {
			...
			out.print("<td class='"+cls+"' onclick='selectDate("+year+","+month+","+i+");'>"+i+"</td>");
		...
		for(int i=(week-1)%7; i<6; i++) {
			out.print("<td class='gray' onclick='selectDate("+nextYear+","+nextMonth+","+n+");'>"+(n++)+"</td>");
		}
		out.print("</tr>");
